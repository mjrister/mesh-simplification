...
In computer graphics, performance is often directly correlated to the complexity of the scene. One technique for dealing with performance bottlenecks is to simplify a polygon mesh by reducing the number of triangles that compose it. This project presents an efficient algorithm to achieve this, first described by Garland-Heckbert in the seminal research paper [Surface Simplification Using Quadric Error Metrics](https://github.com/matthew-rister/mesh-simplification/blob/main/MeshSimplification/docs/surface_simplification.pdf).
