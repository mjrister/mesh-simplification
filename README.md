...
In computer graphics, performance is often directly correlated to the complexity of the scene being rendered. One technique for dealing with performance bottlenecks is to simplify a polygon mesh by reducing the number of triangles that comprise it while preserving its original shape as much as possible. This project presents an efficient algorithm to achieve this first presented by Garland-Hceckbert in a seminal research paper entitled [Surface Simplification Using Quadric Error Metrics](https://github.com/matthew-rister/mesh_simplification/blob/main/MeshSimplification/docs/surface_simplification.pdf). 
